        ...
        <div className="group relative bg-[#1a1a1a] rounded-lg overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/50 cursor-pointer">
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-center text-xs text-gray-400">
                    <span className={`px-2 py-1 rounded-sm ${anime.status === 'Currently Airing' ? 'bg-green-900/30 text-green-400' : 'bg-gray-800'}`}>
                        {anime.status === 'Currently Airing' ? 'RUNNING' : 'FINISHED'}
                    </span>
